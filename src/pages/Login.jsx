  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
      ...
      <div className="relative w-full basis-4/5 bg-zinc-600 flex flex-col justify-center items-center gap-6">
        <div className="custom-shape-divider-top-1691282975">
          <svg
            data-name="Layer 1"
        ...
        <p className="text-white text-3xl font-bold">Wroteit</p>
        <input
          type="text"
          className="border-b-white border-b px-2 h-10 text-white focus:outline-none bg-zinc-600 placeholder:text-white"
